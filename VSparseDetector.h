...
#include "Utf.h"
#include "N3L.h"
#include "basic/VSparseClassifier.h"
...
public:
  ...
  void extractLinearFeatures(vector<vector<string> >& features, const Instance* pInstance);
  void convert2Example(const Instance* pInstance, vector<Example>& exam);
  void initialExamples(const vector<Instance>& vecInsts, vector<vector<Example> >& vecExams);
