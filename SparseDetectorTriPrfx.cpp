  ...
  for (int i = 0; i < seq_size; i++) {
    ...
    for (int j = 0; j < wordnumber; j++) {
      if (i == 0) {
        ...
        feat = "CTBF3T=" + prev2word + seperateKey + prevword + seperateKey + curr_words[j];
        features.push_back(feat);
        ...
        features.push_back(feat);
        string prev2word = j - 2 >= 0 ? curr_words[j - 2] : nullkey;
        feat = "PKUF3T=" + prev2word + seperateKey + prevword + seperateKey + curr_words[j];
        features.push_back(feat);
        ...
        features.push_back(feat);
        string prev2word = j - 2 >= 0 ? curr_words[j - 2] : nullkey;
        feat = "CHARF3T=" + prev2word + seperateKey + prevword + seperateKey + curr_words[j];
        features.push_back(feat);
